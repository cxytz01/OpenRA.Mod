...
raider =
    .description =
    House Ordos "business upgrade" to the standard Trike. Twin 20mm cannons. A tuned engine only available
    through Sigma Draconis IV middlemen. Zero armor — yes, literally none — but when you're faster than
...
deviator =
    .description =
    The most unsettling invention in the Ordos arsenal. A missile wrapped in a cloud of silicon-based
    neuro-gas that slips through enemy armor and temporarily rewrites the crew's loyalty. One moment
...
devastator-desc =
    .description =
    House Harkonnen's statement in steel. The heaviest battle tank on Arrakis. Twin plasma cannons ionize
    the air when they fire. The ground sinks when it moves. When damage is too severe to continue, the
    crew activates fusion overload — the reactor goes critical and detonates. Five and a half cells of
    melted glass remain. Glory. Or madness. Sometimes they're the same thing.
...
combat-tank-o =
    ...
    worry about. But if the war lasts long enough — rate of fire always wins.
      Strong vs Tanks, Vehicles
      Weak vs Infantry
...
laser-orni =
    ...
    instantaneous red beam. No trajectory to predict. No guidance to track. Point. Burn. Repeat. Anti-air
    and anti-ground. Hover. Aim. Ignite.
      Strong vs Infantry, Light Vehicles, Air
      Weak vs Anti-air
...
air-fortress =
    .description =
    If the Devastator could fly, it would look like this. A massive hovering gunship cruising at cloud
    altitude. Shock cannons on both flanks tear into the ground. A rapid-fire turret on top reaps the
    sky. Slow — so slow you forget it's moving — but when it slides above your base, the entire radar
    screen turns red.
...
research-centre =
    ...
    leaves here carries an Ixian stamp and a twenty-page NDA.
...
starport-desc =
    ...
    speed depends on whether the Guild Navigator in orbit had one spice beer too many. A good order
    saves ten minutes of tank production.
...
silo =
    .description =
    A tower stands on the sand. Inside: spice. Nothing else.
...
palace-corrino =
    .description =
    The Empire has only a shadow here. The shadow is enough.
...
atreides-airstrike = Atreides Airstrike
    .description =
    Ornithopters were never the first choice of House Atreides. But when they appear — snake formation,

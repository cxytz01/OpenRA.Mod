...
| `StructureProductionActiveDelay` | 活跃检查间隔(tick) | `25` | (默认) | |
...
| `MaxResourceCellsToCheck` | 炼厂选址矿点检查数 | `3` | `10` | |
| `CheckForNewBasesDelay` | 扫码新基地间隔(tick) | `1500` | `1500` | |
| `MinimumDefenseRadius` | 防御最小距离(格) | `5` | (默认) | |
| `MaximumDefenseRadius` | 防御最大距离(格) | `20` | (默认) | |
| `NewProductionCashThreshold` | 余钱加建工厂阈值 | `5000` | `1000` | |
| `ProductionMinCashRequirement` | 最低建造现金 | `500` | `500` | |
...
|------|------|--------|------------------------------------------|
| `refinery` | 精炼厂 | 14 | |
| `refinery_inverted` | 精炼厂(反向) | 8 | |
| `wind_trap` | 风电厂 | - | |
| `barracks` | 兵营 | 5 | |
| `light_factory` | 轻工厂 | 1 | |
| `outpost` | 前哨站 | 2 | |
| `heavy_factory` | 重工厂 | 3 | |
| `high_tech_factory` | 高科技工厂 | 5 | |
| `repair_pad` | 修理平台 | 2 | |
| `research_centre` | 研究中心 | 3 | |
| `starport` | 星港 | 5 | |
...
| `silo` | 仓库 | - | |
| `medium_gun_turret` | 中型炮塔 | 3 | |
| `large_gun_turret` | 火箭炮塔 | 5 | |
| `upgrade.conyard` | 建造场升级 | 1 | |
| `upgrade.barracks` | 兵营升级 | 1 | |
| `upgrade.light` | 轻工厂升级 | 1 | |
| `upgrade.heavy` | 重工厂升级 | 1 | |
